...
import com.baqr.baqrcam.streaming.rtsp.UriParser;

import android.util.Log;

/**
 * 
 * HTTP server of Baqrcam.
 * 
 * Its document root is assets/www, it contains a little user-friendly website to control baqrcam from a browser.
 * 
	...
	private CallbackListener mListener = new CallbackListener() {
		...
		public void onError(TinyHttpServer server, Exception e, int error) {
			if (error==ERROR_START_FAILED) {
				BaqrApplication.getInstance().lastCaughtException = e;
			}
		}
		@Override
