...
public class BaqrGoogleMaps extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.baqr_map);
        ...
        if (!dataExists) {
            ...
            GPSTracker gps = new GPSTracker(BaqrGoogleMaps.this);
	...
	public boolean MapMyTags() {
		...
		MsgDatabaseHandler mdb = new MsgDatabaseHandler(BaqrGoogleMaps.this);
	...
	public void showSettingsAlert(){
		AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(BaqrGoogleMaps.this);
        alertDialogBuilder
                ...
                .setPositiveButton("Enable GPS",
                        new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog,
                                ...
                                BaqrGoogleMaps.this.startActivity(callGPSSettingIntent);
                            }
                        });
