...
public class WiFiControl extends BluetoothActivity
{
	...
	protected void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.baqrblue_wifi_control);
	...
	public class ServerThread implements Runnable
	{
		...
		public void run()
		{
			...
			handler.obtainMessage(BaqrApplication.MSG_1, R.id.tvIP, 0, SERVERIP + ":" + SERVERPORT).sendToTarget();
			try
			{
